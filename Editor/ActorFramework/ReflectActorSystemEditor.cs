...
namespace Unity.Reflect.Viewer
{
    ...
    public class ReflectActorSystemEditor : Editor
    {
        ...
        void BuildDefaultSection(VisualElement container)
        {
            ...
            if (iterator.NextVisible(true))
            {
                do
                {
                    ...
                    if (iterator.propertyPath == nameof(ReflectActorSystem.Asset))
        ...
        void OnAssignedAssetChanged(SerializedPropertyChangeEvent evt)
        {
            if (m_SubEditor == null)
            {
                var assetProperty = serializedObject.FindProperty(nameof(ReflectActorSystem.Asset));
