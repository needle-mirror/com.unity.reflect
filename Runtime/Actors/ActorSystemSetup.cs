...
namespace Unity.Reflect.Actor
{
    ...
    {
        Type GetOutputMessageType(FieldInfo fieldInfo);
    }
    ...
    public class ComponentConfig : IConfigIdentifier
    {
        ...
        public ComponentConfig(string id, bool isGeneratedId, string typeNormalizedFullName,
    ...
    public class ActorPortConfig : IConfigIdentifier
    {
        ...
        public ActorPortConfig(string id, bool isGeneratedId, string componentConfigId, string typeNormalizedFullName,
            string messageTypeNormalizedFullName, string memberName, PortType portType, string displayName, bool isRemoved)
        {
            Id = id;
            IsGeneratedId = isGeneratedId;
