...
{
    [Actor("0ab5aaa7-b16b-4067-829c-62272104e17a")]
...
#pragma warning restore 649
        ...
        Dictionary<Type, List<ActorHandle>> m_Receivers = new Dictionary<Type, List<ActorHandle>>();
        ...
        void OnSubscribeToEvent(NetContext<EventComponent.SubscribeToEvent> ctx)
        {
            ...
            {
                receivers = new List<ActorHandle>();
        ...
        void OnEventMessage(NetContext<EventMessage<object>> ctx)
        {
            ...
            m_Net.Forward(receivers, ctx.Message);
        }
    }
}
