...
{
    public sealed class RadialMenuUI : MonoBehaviour, IUsesConnectInterfaces, IUsesRequestStencilRef, IUsesFunctionalityInjection
    {
...
#pragma warning disable 649
        ...
        [SerializeField]
        bool m_HideOnSelectNothing = true;

        [SerializeField]
        bool m_UseOnlyDefaultActions = true;
#pragma warning restore 649
        ...
        public List<ActionMenuData> actions
        {
            ...
            set
            {
                ...
                {
                    m_Actions = value
                        .Where(a => a.sectionName != null && !m_UseOnlyDefaultActions || a.sectionName == ActionMenuItemAttribute.DefaultActionSectionName)
        ...
        public bool pressedDown
        {
            ...
            set
            {
                if (m_PressedDown != value)
                {
                    ...
                    if (m_HighlightedButton == null || m_HighlightedButton.orderIndex >= m_Actions.Count)
                    {
                        // No button was selected on the Radial Menu. Close the radial menu, and deselect.
                        Selection.activeGameObject = null;
                        if (m_HideOnSelectNothing)
                        {
                            visible = false;
                        }
                        buttonClickedNoHighlight?.Invoke();
                    }
                }
            }
        }
