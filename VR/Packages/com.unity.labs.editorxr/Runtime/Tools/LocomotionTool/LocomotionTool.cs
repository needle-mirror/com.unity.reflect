...
{
    public sealed class LocomotionTool : MonoBehaviour, ITool, ILocomotor, IUsesRayOrigin, IUsesRayVisibilitySettings,
        ...
        IUsesDeviceType, IUsesGetVRPlayerObjects, IUsesBlockUIInteraction, IUsesRequestFeedback, IUsesNode, IUsesFunctionalityInjection
    {
        ...
        const string k_Teleport = "Teleport";
        const string k_Fly = "Fly";
        const string k_Forward = "Forward";
        const string k_Speed = "Speed";
        const string k_ExtraSpeed = "Extra Speed";
        const string k_ExtraDistance = "Extra Distance";
...
#pragma warning restore 649
        ...
        public bool enableCrawling
        {
            get { return m_EnableCrawling; }
            set { m_EnableCrawling = value; }
        }

        public bool enableRotating
        {
            get { return m_EnableRotating; }
            set { m_EnableRotating = value; }
        }

        public bool enableScaling
        {
            get { return m_EnableScaling; }
        ...
        {
            ShowFeedback(m_MainButtonFeedback, k_Blink, k_Teleport);
            ShowFeedback(m_MainButtonFeedback, k_Forward, k_Fly);
        }
        ...
        {
            ShowFeedback(m_SpeedFeedback, k_Speed, m_Preferences.blinkMode ? k_ExtraDistance : k_ExtraSpeed);
        }
