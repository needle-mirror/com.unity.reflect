...
namespace UnityEditor.Experimental.EditorVR.Modules
{
    ...
    public class MultipleRayInputModule : RayInputModule, IUsesPointer, IUsesConnectInterfaces, IProvidesAddRaycastSource,
        ...
        IProvidesGetRayEventData
    {
        class RaycastSource : ICustomActionMap, IUsesRequestFeedback, IRaycastSource
        {
            ...
            public void ProcessInput(ActionMapInput input, ConsumeControlDelegate consumeControl)
            {
                ...
                // Send scroll events
                if (m_Owner.m_TouchScrollingEnabled && currentObject)
                {
        ...
        [SerializeField]
        bool m_TouchScrollingEnabled = true;
        ...
        public override void Process()
        {
            ...
            if (m_EventCamera == null || m_MainCamera == null)
                return;
