...
namespace UnityEditor.Experimental.EditorVR.Core
{
    ...
    public class EditorXRMenuModule : MonoBehaviour, IModuleDependency<EditorXRRayModule>,
        ...
        IInstantiateUI, IUsesViewerScale
    {
        ...
        internal void UpdateMenuVisibilities()
        {
            ...
            foreach (var deviceData in k_ActiveDeviceData)
            {
                ...
                var alternateMenuVisible = alternateMenu != null && menuHideData[alternateMenu].hideFlags == 0;
